...
//       // SSL when cert vars are present
//       let ssl: ConnectionOptions | boolean = false;
//       if (process.env.KAFKA_TRUSTED_CERT && process.env.KAFKA_CLIENT_CERT && process.env.KAFKA_CLIENT_CERT_KEY) {
//         ssl = {
